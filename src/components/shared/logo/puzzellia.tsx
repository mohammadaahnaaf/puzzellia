...
export function PuzzelliaSVG(props: any) {
    return (
        <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 543.41 543.41">
            <polygon className="cls-1" style={{ fill: '#ed1a3d', stroke: '#fff200', strokeMiterlimit: '10', strokeWidth: '4px' }}
            ...
            <polygon className="cls-2" style={{ fill: '#F9A8D4', stroke: '#fff200', strokeMiterlimit: '10', strokeWidth: '4px' }}
